package ch.hszt.kfh.rockstocks.modulators.fourier;
...
public class PitchShift {
	...
	public PitchShift(int maxFrameSize) {
	 ...
	 */
	public synchronized void smbPitchShift(double[] indata, double[] outdata, int offset, int numSampsToProcess)
	/*
